...
// (src/design/tokens.rs) — extended for web UI surfaces.
export const colors = {
  primary: '#6366F1',
  secondary: '#A855F7',
  accent: '#06B6D4',
...
export const spacing = { xsmall: 4, base: 8, small: 12, medium: 16, large: 24, xlarge: 32 };
export const typography = { weights: [400, 500, 600, 700, 800], family: 'Plus Jakarta Sans', mono: 'JetBrains Mono' };
export const borderRadius = { xsmall: 2, sharp: 0, slight: 4, small: 4, medium: 8, rounded: 8, pill: 16 };
