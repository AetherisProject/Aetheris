...
<nav class="sidebar">
    ...
    <ul class="nav-section"><li class="nav-section-title">Advanced</li>
        ...
        <li><a href="design-system.html">Design</a></li></ul>
...
<footer class="footer">
<p>&copy; 2026 Aetheris. MIT License.</p>
<p><a href="https://github.com/merlin-tribukait/Aetheris">GitHub</a> | <a href="security.html">Security</a></p>
</footer>
...
def build_page(md_file, html_file):
    ...
    full = HEADER.format(title=title) + '<main class="content"><div class="content-inner">' + html + "</div></main>\n" + FOOTER
